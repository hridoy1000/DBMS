...
<html lang="en">
    <head>
        ...
        <title>Yotunities | Workshops</title>
...
<div class="container-fluid post-margin bg-header">
  <div class="row">
    <div class="col-md-12 mt-4 mb-0">
      <h1 class="text-left t-blue mb-4 ">Workshops</h1>
      <p class="text-left t-blue mb-5 ">Here you can find all the workshops that are going on.</p>
    </div>
  </div>
  </div>
