          ...
          if(in_array($fileActualExt, $allowed)){
              ...
              if($fileError === 0){
                  ...
                  if($fileSize < 5000000){
                      ...
                      VALUES ('$title', '$description', '$process', '$eligibility', '$benefits', '$type', '$funding', '$deadline', '$start_date', '$end_date', '$fileName', '$link', '$location', '$organizer', '$organizerPhone', '$organizerMail', '$tags')";
