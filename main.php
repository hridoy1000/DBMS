...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="content">
        <div class="text">
            <p><span><b>Yotunities</b>, </span>Where one can find there Dream and get chance to fulfill it..</p>
                                ...
                                <div class="col-md-4 card-description">
                                    ...
                                    <img class="card-img-top" src='".($arrData['featuredImage'])"'  alt="Card image cap">
                                        <div class="card-body text-dark">
                                            ...
                                            <div><p class="card-text"><?php echo htmlspecialchars($arrData['description']); ?></p></div>
                                        </div>
